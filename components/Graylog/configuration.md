...
4. [Configuration de Linux](#4-configuration-de-linux)
   - 4.1 [Installation et vérification de rsyslog](#41-installation-et-vérification-de-rsyslog)
   - 4.2 [Configuration du fichier rsyslog](#42-configuration-du-fichier-rsyslog)
   - 4.3 [Redémarrage du service](#43-redémarrage-du-service)
